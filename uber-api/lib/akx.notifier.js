...
exports._sendSlack = function( template_name, channel, data, req, options ){
    var formData = {
        template_name: template_name,
        channel: channel,
        data: data,
        webhook: msgConfig.slackWebhookSecurityPwned
    };
...
exports.sendSlack = function(){
    if( arguments.length < 4 ){
        return _this._sendSlack( arguments[ 0 ], arguments[ 1 ], arguments[ 2 ], arguments[ 3 ], {} );
    }
    else{
        return _this._sendSlack( arguments[ 0 ], arguments[ 1 ], arguments[ 2 ], arguments[ 3 ], arguments[ 4 ] );
    }
};
