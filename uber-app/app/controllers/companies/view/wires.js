...
export default Ember.ArrayController.extend( AdvancedSearch, {
    paneSecondary: null,
    queryParams: [ 'page', 'perPage', 'type', 'method', 'currency_id', 'name', 'account_holder', 'reference', 'bank_name', 'bank_route_id', 'status', 'amount_min', 'amount_max', 'period_from', 'period_to' ],
    page: 1,
    perPage: 50,
    type: null,
    method: null,
