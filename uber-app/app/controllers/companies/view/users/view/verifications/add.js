...
export default Ember.Controller.extend( EmberValidations.Mixin, {
    needs: [ 'companies/view/users/view', 'companies/view/users/view/verifications', 'application' ],
        ...
        save: function(){
            ...
            self.validate().then(
                function(){
                    ...
                    Ember.run( function(){
                        Ember.$.ajax( {
                            url: config.APP.uber_api_host + '/verifications',
                            type: 'POST',
                            ...
                            function( response ){
                                ...
                                var route = self.container.lookup( 'route:companies.view.users.view.verifications' );
                                route.refresh();
                                self.transitionToRoute( 'companies.view.users.view.verifications' );
                            },
