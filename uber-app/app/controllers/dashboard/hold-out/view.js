    ...
    actions: {
        ...
        unholdWire: function(){
            ...
            self.get( 'wire' ).save().then(
                function(){
                    ...
                    self.container.lookup( 'route:dashboard.hold-out' ).refresh();
                    self.transitionToRoute( 'dashboard.hold-out' );
                },
                function( xhr ){
                    self.set( 'isLocked', false );
                    self.get( 'akxUtil' ).handleError( xhr, {
        ...
        cancelWire: function(){
            ...
            Ember.$.ajax( {
                ...
                function(){
                    var route = self.container.lookup( 'route:dashboard.hold-out' );
