...
export default Ember.Controller.extend( EmberValidations.Mixin, {
    ...
    actions: {
        createReport: function(){
            ...
            var newReport = self.store.createRecord( 'uber-sar-report', self.get( 'uberSarReport' ) );

            newReport.set( 'raw_data', JSON.stringify( rawData ) );

            newReport.save().then(
                function(){
                    self.set( 'isLocked', false );
                    self.notify.success( 'Suspicious Activity Report Created', { closeAfter: 5000 } );
