...
export default Ember.Component.extend( {
    ...
    renderComponent: function(){
        ...
        Ember.run( function(){
            Ember.$.ajax( {
                url: config.APP.uber_api_host + '/analytics/transactions-invoice?currency_id=' + self.get( 'currency.id' ) + '&from_date=' + self.get( 'from_date' ) + '&to_date=' + self.get( 'to_date' ) + '&company_id=' + self.get('company.id'),
                type: 'GET'
            } ).then(
                function( response ){
