...
export default Ember.Handlebars.makeBoundHelper( function( status ){
    ...
    switch( status ){
        ...
        case 4:
            ...
            break;
        case 5:
            icon = '<span  class="hint--left hint--rounded" data-hint="Rejected"><i class="text-rose fa fa-minus-circle fa-fw"></i></span>';
            break;
        case 9:
            icon = '<span  class="hint--left hint--rounded" data-hint="To Be Checked"><i class="text-orange fa fa-question-circle-o fa-fw"></i></span>';
            break;
        default:
            icon = '';
    }
