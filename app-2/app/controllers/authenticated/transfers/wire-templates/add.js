...
export default Ember.Controller.extend( {
    ...
    actions: {
        saveModel(){
            ...
            if( changeset.get( 'intermediary_bank_code_swift' ) ){
                changeset.set( 'intermediary_bank_code_swift', changeset.get( 'intermediary_bank_code_swift' ).toUpperCase() );
            }
