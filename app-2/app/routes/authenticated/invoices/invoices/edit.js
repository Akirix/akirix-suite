...
export default Ember.Route.extend( AuthenticatedRouteMixin, StringObjectMixin, {
    ...
    setupController( controller, model ){
        ...
        if( model.invoice.get( 'type' ) === 2 ){
            ...
            changeset.set( 'invoice_period_from', this.get( 'intl' ).formatDate( changeset.get( 'invoice_period_from' ) ) );
            changeset.set( 'invoice_period_to', this.get( 'intl' ).formatDate( changeset.get( 'invoice_period_to' ) ) );
        ...
        this.send( 'openSidePanel', 'invoices/edit', '', controller );
    },
